...
// generalny kontroller kontrolerów admina
abstract class AdminController extends GeneralController {
	...
	protected function msg($state,$text) {
        ...
        $_SESSION[$this->_config->dbTableNames->Pracownik]['msg'] = array("text"=>$text,"state"=>$state);
    }
}
?>